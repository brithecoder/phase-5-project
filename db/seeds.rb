...
be9=BrandEvent.create(brand_id:b2.id,event_id:e1.id)
be10=BrandEvent.create(brand_id:b1.id,event_id:e3.id)
...
# be17=BrandEvent.create(brand_id:,event_id:)
# be18=BrandEvent.create(brand_id:,event_id:)
# be19=BrandEvent.create(brand_id:,event_id:)
# be20=BrandEvent.create(brand_id:,event_id:)
# be21=BrandEvent.create(brand_id:,event_id:)
# be22=BrandEvent.create(brand_id:,event_id:)
